...
sealed class Screens(
    ...
    object SetMeasure :
        Screens("setMeasure", R.string.set_measure, R.drawable.ic_launcher_foreground)

    object SetTargetRange :
        Screens("setTargetRange", R.string.set_target_range, R.drawable.ic_launcher_foreground)

    object SetMedicament :
        Screens("setMedicament", R.string.set_medicament, R.drawable.ic_launcher_foreground)
    ...
    object CalendarMonthView :
        Screens("calendarMonthView", R.string.calendar, R.drawable.ic_baseline_calendar_month_24)

    object CalendarListView : Screens(
        "calendarListView",
        R.string.calendar_list_view,
        R.drawable.ic_baseline_calendar_month_24
    )

    object CalendarDay :
        Screens("calendarDay", R.string.calendar_day, R.drawable.ic_baseline_calendar_month_24)

    object CalendarComment : Screens(
        "calendarCommentScreen",
        R.string.calendar_comment,
        R.drawable.ic_baseline_calendar_month_24
    )

    object StatisticCharts :
        Screens("statisticChartsScreen", R.string.statistc_charts, R.drawable.statistics)
